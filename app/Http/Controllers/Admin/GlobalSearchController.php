...
{
    private $models = [
        'Medizingerate'     => 'cruds.medizingerate.title',
        'Workflow'          => 'cruds.workflow.title',
        'WorkflowPath'      => 'cruds.workflowPath.title',
        'Risiken'           => 'cruds.risiken.title',
        'Result'            => 'cruds.result.title',
        'DicomNamerConv'    => 'cruds.dicomNamerConv.title',
        'RayStationtwoConv' => 'cruds.rayStationtwoConv.title',
    ];
