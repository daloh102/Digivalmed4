...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.rayStationtwoConv.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ray-stationtwo-convs.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="source_ip">{{ trans('cruds.rayStationtwoConv.fields.source_ip') }}</label>
                <input class="form-control {{ $errors->has('source_ip') ? 'is-invalid' : '' }}" type="text" name="source_ip" id="source_ip" value="{{ old('source_ip', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dest_ip') ? 'is-invalid' : '' }}" type="text" name="dest_ip" id="dest_ip" value="{{ old('dest_ip', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('protokoll') ? 'is-invalid' : '' }}" type="text" name="protokoll" id="protokoll" value="{{ old('protokoll', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('medizingeraet') ? 'is-invalid' : '' }}" type="text" name="medizingeraet" id="medizingeraet" value="{{ old('medizingeraet', '') }}" required>
