    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.results.update", [$result->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $result->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eaid') ? 'is-invalid' : '' }}" type="text" name="eaid" id="eaid" value="{{ old('eaid', $result->eaid) }}" required>
                @if($errors->has('eaid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('eaid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ebene') ? 'is-invalid' : '' }}" type="text" name="ebene" id="ebene" value="{{ old('ebene', $result->ebene) }}" required>
                @if($errors->has('ebene'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ebene') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('risiko') ? 'is-invalid' : '' }}" type="text" name="risiko" id="risiko" value="{{ old('risiko', $result->risiko) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('risikoid') ? 'is-invalid' : '' }}" type="text" name="risikoid" id="risikoid" value="{{ old('risikoid', $result->risikoid) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $result->url) }}" required>
                @if($errors->has('url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('url') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source') ? 'is-invalid' : '' }}" type="text" name="source" id="source" value="{{ old('source', $result->source) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('auswirkung_netto') ? 'is-invalid' : '' }}" type="text" name="auswirkung_netto" id="auswirkung_netto" value="{{ old('auswirkung_netto', $result->auswirkung_netto) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('auswirkung_brutto') ? 'is-invalid' : '' }}" type="text" name="auswirkung_brutto" id="auswirkung_brutto" value="{{ old('auswirkung_brutto', $result->auswirkung_brutto) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eintrittswahrscheinlichkeit_brutto') ? 'is-invalid' : '' }}" type="text" name="eintrittswahrscheinlichkeit_brutto" id="eintrittswahrscheinlichkeit_brutto" value="{{ old('eintrittswahrscheinlichkeit_brutto', $result->eintrittswahrscheinlichkeit_brutto) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eintrittswahrscheinlichkeit_netto') ? 'is-invalid' : '' }}" type="text" name="eintrittswahrscheinlichkeit_netto" id="eintrittswahrscheinlichkeit_netto" value="{{ old('eintrittswahrscheinlichkeit_netto', $result->eintrittswahrscheinlichkeit_netto) }}">
