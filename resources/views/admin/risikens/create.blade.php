...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.risiken.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.risikens.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eintrittswahrscheinlichkeit_netto') ? 'is-invalid' : '' }}" type="text" name="eintrittswahrscheinlichkeit_netto" id="eintrittswahrscheinlichkeit_netto" value="{{ old('eintrittswahrscheinlichkeit_netto', '') }}" required>
