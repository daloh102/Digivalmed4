...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dicomNamerCbcT.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.dicom-namer-cbc-ts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patientenid') ? 'is-invalid' : '' }}" type="text" name="patientenid" id="patientenid" value="{{ old('patientenid', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kv') ? 'is-invalid' : '' }}" type="text" name="kv" id="kv" value="{{ old('kv', '') }}" required>
                @if($errors->has('kv'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kv') }}
                    </div>
